...
Below you'll find predictions for the current NFL season after simulating the remaining schedule 1\,000x. The model uses a regressed version of last season's ending Elo ratings for all 32 teams, and adjusts independently within each simulation as each week is simulated.

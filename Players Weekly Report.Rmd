...
epa_logos <- epa_play %>%
  ...
  labs(
    x = "EPA per Dropback",
    y = "",
    title = "Quarterback Efficiency, 2023 NFL Season",
...
epa_cpoe_logos <- epa_play %>%
  ...
  labs(
    ...
    title = "Quarterback Performance, 2023 NFL Season",
...
qb_success_rate <- qbs %>%
  ...
  labs(
    ...
    subtitle = "2023 season, min 50 pass attempts, includes all QB's rush and pass plays. Size represents no. of plays"
  ) +
  theme_custom() +
  theme(plot.title = element_text(face = "bold", 
                                  size = 20, 

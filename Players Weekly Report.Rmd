...
epa_logos <- epa_play %>%
  ...
  labs(
    x = "EPA per Dropback",
    y = "",
    title = "Team QB Efficiency, 2026 NFL Season",
...
qb_success_rate <- qbs %>%
  ...
  labs(
    ...
    subtitle = "2026 season, min 100 pass attempts, includes all QB's rush and pass plays."
  ) +
  theme_custom() +
  theme(plot.title = element_text(face = "bold", 
                                  size = 20, 
